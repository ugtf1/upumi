      ...
      <form onSubmit={otpSent ? verifyOtp : requestOtp}>
        ...
        {!otpSent && (
          <label style={{ display: "flex", alignItems: "flex-start", gap: 8, marginTop: 12, marginBottom: 12, fontSize: 12, lineHeight: 1.4, color: "#555" }}>
            ...
            />
            <span>
              By checking this box, you agree to receive one-time passcode (OTP) text messages from Urhobo Global Tech Foundation to authenticate your account when you log in. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe or HELP for support. You can read our <a href="/privacy-policy" target="_blank" rel="noreferrer">Privacy Policy</a> and <a href="/terms-of-service" target="_blank" rel="noreferrer">Terms of Service</a>.
            </span>
          </label>
        )}
